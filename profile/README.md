...
## Installation
Please follow [this guide](https://github.com/Benji377/Raspirus/blob/main/docs/INSTALLATION.md) to build the app on your own machine. Or if you are on Windows, Ubuntu or MacOS, you can try to use the pre-built installers in the [Releases page](github.com/Benji377/Raspirus/releases/latest). If you encounter any difficulties while following the instructions, please open an issue and we will be happy to help you out.
