...
## Installation
Please follow [this guide](https://github.com/Raspirus/docs/blob/main/INSTALLATION.md) to build the app on your own machine. Or if you are on Windows, Ubuntu or MacOS, you can try to use the pre-built installers in the [Releases page](https://github.com/Raspirus/Raspirus/releases/latest). If you encounter any difficulties while following the instructions, please open an issue and we will be happy to help you out.

## Questions
For any questions, check out the [FAQ docs](https://github.com/Raspirus/docs/blob/main/FAQ.md) and see if you can find an answer to your problem. If not, please open an Issue on this repository.
